						...
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px"><b></b><?php echo $movie['cast']; ?></p>
									<p class="p-link" style="font-size:15px"><b> Date : </b><?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
									<p style="font-size:15px"><?php echo $movie['desc']; ?></p>
									<a href="<?php echo $movie['video_url']; ?>" target="_blank" class="watch_but" style="text-decoration:none;">Watch Event/Programs</a>
								</div>
								<div class="clear"></div>
							</div>
							...
							<table class="table table-hover table-bordered text-center">
								...
								<thead>
										<tr>
											...
											<th class="text-center" style="font-size:16px;"><b>Event Timings</b></th>
										</tr>
									</thead>
							<?php
							...
							{
								?>
								<h3 style="color:#444; font-size:23px;" class="text-center">Currently there no Event/Program available!</h3>
